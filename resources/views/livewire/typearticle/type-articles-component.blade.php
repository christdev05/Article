<div>
    @include("livewire.typearticle.list")
    @include("livewire.typearticle.createprop")
    @include("livewire.typearticle.editprop")
</div>
...
<script>
    window.addEventListener("showEditForm",function(e){
        Swal.fire({
            ...
            //appeler les function livewire avec javascripte
