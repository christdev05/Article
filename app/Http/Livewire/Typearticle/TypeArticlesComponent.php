...
namespace App\Http\Livewire\Typearticle;
...
class TypeArticlesComponent extends Component
{
    use WithPagination;
    public $search = "";
    ...
    public function render()
    {
        ...
        return view('livewire.typearticle.type-articles-component',$data)->layout('layouts.base');
    }
